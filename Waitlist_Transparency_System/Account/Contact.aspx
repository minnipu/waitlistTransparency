...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="UserAccountContent">
    ...
    <tr>
        ...
        <td style="height: 23px">
            <asp:DropDownList ID="ddlState" runat="server" CssClass="dropdown-toggle" Height="22px" Width="128px"></asp:DropDownList>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn btn-default" PostBackUrl="#" />
            <asp:Button ID="btnNext" runat="server" Text="Update" CssClass="btn btn-default" PostBackUrl="#" />
        </td>
    </tr>  
</table>
</asp:Content>